...
# print("working")
class GideonScheduleContext:
    """Class to generate context about Gideon's current activity based on schedules."""
    ...
    def get_current_activity(cls) -> Optional[str]:
        """Get Gideon's current activity based on the current time and day of the week.
    ...
    @classmethod
    def get_schedule_for_day(cls) -> Dict[str, str]:
        ...
        current_datetime = datetime.now()
        current_day = current_datetime.weekday()
        return cls.SCHEDULES.get(current_day, {})