...
from src.graph.state import AICompanionState
from src.graph.utils.chains import (
    get_character_response_chain,
    get_router_chain,
)
from src.graph.utils.helper import (
    get_chat_model,
    get_text_to_image_module,
    get_text_to_speech_module,
)
from src.modules.memory.long_memory_manager import get_memory_manager
...
def context_injection_node(state: AICompanionState):
    schedule_context = GideonScheduleContext.get_current_activity()
...
async def conversation_node(state: AICompanionState, config: RunnableConfig):
    current_activity = GideonScheduleContext.get_current_activity()
...
async def image_node(state: AICompanionState, config: RunnableConfig):
    ...
    scenario_message = HumanMessage(content=f"<image attached by Gideon generated from prompt: {scenario.image_prompt}>")
